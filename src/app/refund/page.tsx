...
import { ArrowLeft, ArrowsClockwise, XCircle, Clock, Package, CreditCard, Warning } from '@phosphor-icons/react'
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="bg-green-50 dark:bg-green-950/30 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-3">We provide refunds for:</h3>
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center">
                  <XCircle className="w-6 h-6 mr-3 text-red-600 dark:text-red-400" />
                  Not Eligible for Refund
                </h2>
                <div className="bg-red-50 dark:bg-red-950/30 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-3">We cannot provide refunds for:</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <section>
                ...
                <div className="bg-blue-50 dark:bg-blue-950/30 p-6 rounded-lg">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h3 className="text-lg font-semibold text-foreground mb-3">Return Request</h3>
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <div className="bg-purple-50 dark:bg-purple-950/30 p-6 rounded-lg">
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-purple-600 dark:bg-purple-700 text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                      <div>
                        <h3 className="font-semibold text-foreground">Contact Support</h3>
                        <p className="text-muted-foreground">Email bhaskarjaikar.1@gmail.com or call +91 8409725206</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-purple-600 dark:bg-purple-700 text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                      <div>
                        <h3 className="font-semibold text-foreground">Get Return Authorization</h3>
                        <p className="text-muted-foreground">We'll provide a Return Authorization Number (RAN)</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-purple-600 dark:bg-purple-700 text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
                      <div>
                        <h3 className="font-semibold text-foreground">Package Items</h3>
                        <p className="text-muted-foreground">Pack items in original packaging with RAN clearly visible</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-purple-600 dark:bg-purple-700 text-white rounded-full flex items-center justify-center text-sm font-bold">4</div>
                      <div>
                        <h3 className="font-semibold text-foreground">Schedule Pickup</h3>
                        <p className="text-muted-foreground">We'll arrange pickup or provide return shipping label</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section>
                <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center">
                  <CreditCard className="w-6 h-6 mr-3 text-orange-600 dark:text-orange-400" />
                  Refund Methods
                </h2>
                <div className="bg-orange-50 dark:bg-orange-950/30 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-3">Refunds will be processed to:</h3>
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 p-4 rounded-lg">
                    <div className="flex items-start space-x-3">
                      <Warning className="w-5 h-5 text-yellow-600 dark:text-yellow-400 mt-1 flex-shrink-0" weight="fill" />
                      <div>
              ...
              <section>
                ...
                <div className="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-3">Cold Chain Products</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-3 mt-6">Bulk Orders</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/30 dark:to-blue-950/30 rounded-lg border border-green-200 dark:border-green-800">
              <div className="text-center">
                <CheckCircle className="w-12 h-12 text-green-600 dark:text-green-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-foreground mb-2">Customer Satisfaction Guarantee</h3>
                <p className="text-muted-foreground">
