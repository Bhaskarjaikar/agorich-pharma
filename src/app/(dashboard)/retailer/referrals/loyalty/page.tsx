      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loyaltyData.nextTier && (
          <motion.div
            ...
            className="mb-8"
          >
            <Card className="border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm">
              <CardHeader>
                ...
                {Object.entries(TIER_CONFIG).map(([tier, config], index) => (
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      {loyaltyData.currentTier.level === tier && (
                        <Badge className="bg-blue-500/20 text-blue-100 border-blue-400/30 mt-2">
                          Current Tier
                        </Badge>
                      )}
                    </div>
