...
export default function SupportHub() {
  ...
  const quickActions = [
    ...
    { icon: Video, title: 'Video Call', description: 'Schedule a video consultation', action: 'video' },
    { icon: FileText, title: 'Create Ticket', description: 'Submit a detailed support request', action: 'ticket' },
    { icon: Bot, title: 'AI Assistant', description: 'Get instant answers from our bot', action: 'bot' }
  ]
