...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-50 border-b border-border bg-card/90 backdrop-blur-md supports-[backdrop-filter]:bg-card/75">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 md:h-16 gap-3">
            <div className="flex items-center space-x-3 md:space-x-4 min-w-0">
              <Link
                href="/retailer"
                className="flex items-center shrink-0 transition-colors text-sm md:text-base text-muted-foreground hover:text-foreground"
              >
              ...
              <div className="flex items-center space-x-2 md:space-x-3 min-w-0">
                <div className="icon-squirclexs md:icon-squircle shrink-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="hidden md:block text-sm text-muted-foreground truncate">{t('settings.manageAccount')}</p>
                </div>
              </div>
            </div>

            <div className="flex items-center gap-2 shrink-0">
              <Badge className="hidden sm:inline-flex border border-emerald-500/30 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400">
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm overflow-hidden transition-shadow hover:shadow-md">
                <div className="flex items-center gap-3 border-b border-border bg-muted/20 p-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-foreground">{t('settings.personalInformation')}</h3>
                    <p className="text-sm text-muted-foreground">{t('settings.updatePersonalDetails')}</p>
                  </div>
                </div>
                <div className="space-y-4 p-5 md:p-6">
                    ...
                    <div className="relative">
                      {profilePhoto ? (
                        ...
                        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-muted">
                          <User className="h-8 w-8 text-muted-foreground" weight="thin" />
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <label
                          ...
                          className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-border bg-secondary px-3 py-1.5 text-sm font-medium text-secondary-foreground transition-colors hover:bg-muted"
                        >
                          {isUploadingPhoto ? (
                            <div className="flex items-center">
                              <div className="mr-2 h-3 w-3 animate-spin rounded-full border-b-2 border-muted-foreground"></div>
                        ...
                        {profilePhoto && (
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="h-8 px-2 border-border text-muted-foreground hover:border-destructive/40 hover:bg-destructive/10 hover:text-destructive"
                          >
                            <X className="w-4 h-4" />
                          </Button>
                        )}
                  ...
                  <div className="grid grid-cols-[100px_1fr] md:grid-cols-[140px_1fr] items-start gap-2 md:gap-3 py-1">
                    <label className="text-sm font-medium text-foreground md:pt-2 truncate">
                      {t('settings.email')}
                    </label>
                    <div>
                      <Input
                        ...
                        disabled
                        className="h-9 w-full text-sm bg-muted/50 text-muted-foreground"
                      />
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm overflow-hidden transition-shadow hover:shadow-md">
                <div className="flex items-center gap-3 border-b border-border bg-muted/20 p-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-foreground">{t('settings.businessInformation')}</h3>
                    <p className="text-sm text-muted-foreground">{t('settings.updateBusinessDetails')}</p>
                  </div>
                </div>
                <div className="space-y-4 p-5 md:p-6">
                  <div className="grid grid-cols-[100px_1fr] md:grid-cols-[140px_1fr] items-center gap-2 md:gap-3 py-1">
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm overflow-hidden transition-shadow hover:shadow-md">
                <div className="flex items-center gap-3 border-b border-border bg-muted/20 p-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-foreground">{t('settings.addressInformation')}</h3>
                    <p className="text-sm text-muted-foreground">{t('settings.updateAddressDetails')}</p>
                  </div>
                </div>
                <div className="space-y-4 p-5 md:p-6">
                  <div className="grid grid-cols-[100px_1fr] md:grid-cols-[140px_1fr] items-start gap-2 md:gap-3 py-1">
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm overflow-hidden transition-shadow hover:shadow-md">
                <div className="flex items-center gap-3 border-b border-border bg-muted/20 p-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-foreground">{t('settings.bankingInformation')}</h3>
                    <p className="text-sm text-muted-foreground">{t('settings.updateBankingDetails')}</p>
                  </div>
                </div>
                <div className="space-y-4 p-5 md:p-6">
                  <div className="grid grid-cols-[100px_1fr] md:grid-cols-[140px_1fr] items-center gap-2 md:gap-3 py-1">
                  ...
                  <div className="grid grid-cols-[100px_1fr] md:grid-cols-[140px_1fr] items-center gap-2 md:gap-3 py-1">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-2 top-1 md:top-1.5 flex h-6 w-6 items-center justify-center text-muted-foreground transition-colors hover:text-foreground"
                      >
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm p-3">
                ...
                >
                  {isSaving ? (
                    <div className="flex items-center">
                      <div className="mr-2 h-4 w-4 animate-spin rounded-full border-2 border-primary-foreground/40 border-t-primary-foreground"></div>
                      {t('settings.saving')}
                    </div>
                  ) : (
                    <div className="flex items-center">
            ...
            >
              <div className="rounded-2xl border border-border bg-card text-card-foreground shadow-sm p-3">
                <Button 
                  ...
                  className="h-10 w-full border-border text-destructive hover:bg-destructive/10 hover:text-destructive"
                  variant="outline"
                >
