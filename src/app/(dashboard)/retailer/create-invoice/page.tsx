...
export default function CreateInvoicePage() {
  ...
  const UPI_ID = process.env.NEXT_PUBLIC_UPI_ID || '8409725206@kotak811'
  const UPI_NAME = process.env.NEXT_PUBLIC_UPI_RECIPIENT_NAME || 'Bhaskar Kumar'
...
// Cancel payment verification
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white">Loading customer profile...</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 border-b border-blue-500 p-3 md:p-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3">
          {/* Left Section */}
          <div className="flex items-center flex-wrap gap-2 md:gap-4">
            <Link href="/retailer/invoices" className="flex items-center text-white hover:text-blue-200 text-sm md:text-base">
          ...
          <div className="flex items-center justify-between md:justify-end gap-3 md:gap-4">
            <div className="text-white text-xs md:text-sm">
              <span className="text-blue-200">Items:</span> {cartItems.length} | 
              <span className="text-blue-200 ml-1 md:ml-2">Total:</span> {formatCurrency(getGrandTotal())}
            </div>
      ...
      <div ref={containerRef} className="hidden md:flex h-[calc(100vh-80px)]">
          ...
          <div className="flex-1 overflow-auto p-4">
            {productsLoading ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                >
                  <Card className="border-0 shadow-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 group">
                    <CardContent className="p-4">
                      <div className="space-y-4">
                        {/* Product Header with Image and Basic Info */}
                        <div className="flex items-start space-x-4">
                          <div className="relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-green-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
                            ...
                            {cartItems.find(item => item.product.id === product.id) ? (
                              <div className="flex items-center space-x-2">
                                ...
                                <Input
                                  ...
                                  className="w-16 h-8 text-center text-white bg-white/10 border-orange-500/30 focus:border-orange-500 focus:ring-orange-500/20"
                                />
                                <Button
                                  size="sm"
                                  variant="outline"
                              ...
                              >
                                ...
                                {t('invoice.addToCart', 'Add to Cart')}
                              </Button>
                            )}
                          </div>
                        </div>
        ...
        >
          ...
          <GripVertical className="w-4 h-4 text-white/60 group-hover:text-white/80 ml-1 transition-colors duration-200" />
        </div>
            ...
            <div className="border-2 border-gray-400 p-4 rounded-lg bg-white shadow-lg relative overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-700">2, Bhushan market, Baruraj thana chowk</p>
                  <p className="text-gray-700">Baruraj, motipur, muzaffarpur</p>
                  <p className="text-gray-700">MUZAFFARPUR, BIHAR - 843132</p>
                  <p className="text-gray-700">GSTIN: 04AAKCD0849F1ZU</p>
                  <p className="text-gray-700">DL.No: WLF21B2023CH0002</p>
                  <p className="text-gray-700">Phone: +91 8409725206</p>
                  <p className="text-gray-700">Email: automation@agorich.com</p>
                </div>
                
                {/* Center - Invoice Details */}
                <div className="text-center">
                  <h1 className="text-2xl font-bold text-blue-600 mb-2">GST INVOICE</h1>
              ...
              {cartItems.length > 0 && (
                <div className="space-y-2 text-sm bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="flex justify-between font-bold text-lg border-t border-gray-300 pt-2">
                    <span className="text-gray-800">{t('invoice.grandTotal', 'Grand Total')}:</span>
                  ...
                  {/* Action Instruction - Lead Magnet (Hindi + English) */
                  }
                  <div className="mt-4">
                    <div className="rounded-lg border border-blue-300 bg-blue-50 text-blue-900 p-3 text-sm">
                      ...
                      <p className="mb-2">
                        Please save this invoice and share it on WhatsApp at <a href="https://wa.me/918409725206" target="_blank" rel="noopener noreferrer" className="underline font-semibold">+91 8409725206</a> or <a href="tel:+918409725206" className="underline font-semibold">call</a> us. Our Management Team will reach out immediately and fast‑track your order <span className="font-semibold">today</span>.
                      </p>
                      <p className="font-semibold mb-1">अगला चरण (उच्च प्राथमिकता)</p>
                      <p>
                        कृपया invoice तैयार होते ही इसे सेव करें और WhatsApp पर <a href="https://wa.me/918409725206" target="_blank" rel="noopener noreferrer" className="underline font-semibold">+91 8409725206</a> पर साझा करें या इसी नंबर पर <a href="tel:+918409725206" className="underline font-semibold">कॉल</a> करें। हमारी Management Team तुरंत आपसे संपर्क करेगी और आपका ऑर्डर <span className="font-semibold">आज ही</span> तेज़ी से प्रोसेस कर देगी।
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-2 border-gray-400 p-2 rounded-lg bg-white shadow-lg relative overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-2 mb-3 text-xs">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-[10px] leading-tight">2, Bhushan market, Baruraj thana chowk</p>
                  <p className="text-gray-700 text-[10px] leading-tight">Baruraj, motipur, muzaffarpur</p>
                  <p className="text-gray-700 text-[10px] leading-tight">MUZAFFARPUR, BIHAR - 843132</p>
                  <p className="text-gray-700 text-[10px] leading-tight">GSTIN: 04AAKCD0849F1ZU</p>
                  <p className="text-gray-700 text-[10px] leading-tight">DL.No: WLF21B2023CH0002</p>
                  <p className="text-gray-700 text-[10px] leading-tight">Phone: +91 8409725206</p>
                  <p className="text-gray-700 text-[10px] leading-tight">Email: automation@agorich.com</p>
                </div>

                {/* Center - Invoice Details */}
                <div className="text-center">
                  <h1 className="text-sm font-bold text-blue-600 mb-1">GST INVOICE</h1>
