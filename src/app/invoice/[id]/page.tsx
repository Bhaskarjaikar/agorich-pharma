      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="bg-white shadow-2xl mb-6 relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-5 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-9xl font-bold text-gray-400 rotate-[-45deg]">
              AGORICH
            </div>
          </div>
          <CardContent className="p-6 md:p-8 relative z-10">
            ...
            <div className="border-b-2 border-gray-300 pb-4 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-1">
                  <h2 className="text-xl font-bold text-gray-800 mb-2">Invoice Preview</h2>
                  <h3 className="text-lg font-bold text-gray-700 mb-3">AGORICH PHARMACEUTICALS</h3>
                  <div className="text-xs text-gray-600 space-y-1">
                    <p>2, Bhushan market, Baruraj thana chowk, Baruraj, motipur, muzaffarpur, MUZAFFARPUR, BIHAR - 843132</p>
                    <p><strong>GSTIN:</strong> 04AAKCD0849F1ZU</p>
                    <p><strong>DL.No:</strong> WLF21B2023CH0002</p>
                ...
                <div className="col-span-1 text-center">
                  <h1 className="text-3xl font-bold text-blue-600 mb-1">GST INVOICE</h1>
                  <p className="text-sm text-gray-600 mb-4">CREDIT</p>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300 text-xs">
                  <thead className="bg-gray-100">
                    <tr>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">SN</th>
                      <th className="border border-gray-300 px-2 py-2 text-left font-semibold">Product Name</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">Pack</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">Qty</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">Batch</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">Mfg</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">EXP</th>
                      <th className="border border-gray-300 px-2 py-2 text-right font-semibold">MRP</th>
                      <th className="border border-gray-300 px-2 py-2 text-right font-semibold">Rate</th>
                      <th className="border border-gray-300 px-2 py-2 text-center font-semibold">GST</th>
                      <th className="border border-gray-300 px-2 py-2 text-right font-semibold">Amount</th>
                    </tr>
                  </thead>
                  <tbody>
                    {invoice.invoice_items.map((item, index) => {
                      ...
                      return (
                        <tr key={item.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          ...
                          <td className="border border-gray-300 px-2 py-2 text-left font-medium">{item.product_name}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">{item.pack_size || '-'}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">{item.quantity}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">{item.batch_number || '-'}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">{formatMfg(item.manufacturer)}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">{formatDateShort(item.expiry_date)}</td>
                          <td className="border border-gray-300 px-2 py-2 text-right">{item.mrp ? `₹${item.mrp.toFixed(0)}` : '-'}</td>
                          <td className="border border-gray-300 px-2 py-2 text-right">₹{item.rate_per_unit.toFixed(0)}</td>
                          <td className="border border-gray-300 px-2 py-2 text-center">5%</td>
                          <td className="border border-gray-300 px-2 py-2 text-right font-semibold">₹{item.total_with_tax.toFixed(0)}</td>
                      </tr>
                      )
                    })}
                  </tbody>
            ...
            <div className="mb-6">
              <div className="flex justify-end space-x-8 text-sm">
                <div className="text-right space-y-1">
                  ...
                  <p className="text-lg font-bold text-blue-600">Grand Total:</p>
              </div>
                <div className="text-right space-y-1 min-w-[100px]">
                  ...
                  <p className="text-lg font-bold text-blue-600">₹{invoice.grand_total.toFixed(0)}</p>
              </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-gray-300">
              <h4 className="text-sm font-semibold text-gray-900 mb-3">Our Bank Details</h4>
              <div className="text-xs text-gray-700 space-y-2">
                <div className="flex items-center gap-2">
                  <span><strong>Bank Name:</strong> Kotak Mahindra Bank</span>
                </div>
                <div className="flex items-center gap-2 flex-wrap">
                  <span><strong>Account Number:</strong> 7945381010</span>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText('7945381010')
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span><strong>IFSC Code:</strong> KKBK0005651</span>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText('KKBK0005651')
                      alert('IFSC copied!')
                    }}
                    className="ml-1 text-blue-600 hover:text-blue-800 cursor-pointer"
                    title="Copy IFSC"
                ...
                <div className="flex items-center gap-2">
                  <span><strong>Account Holder:</strong> Bhaskar Kumar</span>
                </div>
              </div>
            </div>
            ...
            {!isPaid && (
              <div className="mt-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h4 className="text-yellow-900 font-semibold mb-1 text-sm">Cash on Delivery (COD)</h4>
                  <p className="text-xs text-yellow-800">COD ke liye kripya delivery par cash ready rakhein. High-value orders par advance ki maang ho sakti hai.</p>
                </div>
              </div>
            )}
          </CardContent>
