...
export default function PublicInvoicePage() {
  ...
  // Reload invoice after successful Razorpay payment
  const handleRazorpaySuccess = async (response: RazorpayResponse) => {
    ...
    try {
      ...
      alert('✅ Payment successful! Please refresh the page to see the updated status.')
    }
  }
            ...
            {isPaid ? (
              ...
              <div className="mt-4 md:mt-6 space-y-3">
                ...
                <RazorpayPaymentButton
                  ...
                  customerName={invoice.customer?.business_name || invoice.customer?.user_name || undefined}
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-4 md:py-6 text-base md:text-lg font-semibold shadow-lg"
                />
                ...
                <p className="text-center text-xs md:text-sm text-gray-500 mt-3">
                  Safe & Secure Payment • Powered by Razorpay & UPI
                </p>
