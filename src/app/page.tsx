...
export default function Home() {
  ...
  const features = [
    { icon: <LungsIcon className="w-5 h-5" weight="fill" />, title: 'Respiratory', desc: 'Breathing wellness', image: '/medicines/repiratory.jpg' },
    { icon: <FirstAid className="w-5 h-5" weight="fill" />, title: 'Pain Relief', desc: 'Pain management', image: '/medicines/pain-relief.jpg' },
    { icon: <Sparkle className="w-5 h-5" weight="fill" />, title: 'Vitamins', desc: 'Nutritional supplements', image: '/medicines/vitamins.jpg' },
    { icon: <StomachIcon className="w-5 h-5" weight="fill" />, title: 'Gastro Care', desc: 'Digestive health', image: '/medicines/gastro-care.jpg' },
  ]

  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-slate-900' : 'bg-[#fafaf8]'}`}>
      {/* HERO with Slideshow - Clean Design */}
        ...
        <div className="relative z-10 h-full flex items-center justify-center pt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="inline-block border-2 border-white/60 text-white text-xs tracking-[2px] uppercase px-4 sm:px-5 py-2 rounded-full mb-5 backdrop-blur-sm bg-white/10">
                  {t('home.hero.badge')}
                </div>
                ...
                <p className="text-sm sm:text-lg md:text-xl text-white mb-7 leading-relaxed drop-shadow-md font-medium px-2 sm:px-0">
        ...
        <section className="py-10 sm:py-12 px-4 sm:px-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-row gap-4 justify-center items-center">
              {/* Login Button - Blue Theme with hover lift */}
              <Link 
                href="/login"
                className="group inline-flex items-center justify-center bg-blue-600 text-white hover:bg-blue-700 px-10 py-4 rounded-full font-bold text-base shadow-lg shadow-blue-600/25 transition-all duration-300 hover:shadow-xl hover:shadow-blue-600/40 hover:-translate-y-1 min-w-[150px]"
              >
              ...
              {/* Register Button - Orange Theme with hover scale */}
              <Link 
                href="/signup"
                className="group inline-flex items-center justify-center bg-orange-500 text-white hover:bg-orange-600 px-10 py-4 rounded-full font-bold text-base shadow-lg shadow-orange-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/40 hover:scale-105 min-w-[150px]"
              >
      ...
      {/* FEATURES - Cipla-style Image Grid */}
      <section id="features" className="py-12 sm:py-16 px-4 sm:px-6 bg-white dark:bg-slate-900 transition-colors">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Link 
              href="/medicines"
              className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-semibold text-base shadow-lg transition-all hover:shadow-xl"
            >
      ...
      {/* CTA SECTION - Optimistic & Vibrant */}
      <section className="py-4 px-4 sm:px-6 bg-gradient-to-r from-orange-400 via-pink-500 to-rose-500">
        <motion.div 
          initial={{ opacity: 0, y: 10 }} 
          whileInView={{ opacity: 1, y: 0 }} 
          viewport={{ once: true }} 
        ...
        >
          <div className="flex gap-3">
            <a 
              ...
              download
              className="flex-1 flex items-center justify-center gap-2 bg-white text-orange-600 hover:bg-orange-50 px-5 py-3.5 rounded-xl font-bold text-sm sm:text-base transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
      ...
      <footer className={`${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} border-t py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300`}>
