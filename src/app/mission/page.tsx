    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-card/95 dark:bg-card/95 backdrop-blur-md border-b border-border">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <h1 className="font-bold text-foreground">Our Mission</h1>
      ...
      <section className="pb-16 px-4">
        <div className="max-w-3xl mx-auto space-y-6">
          {/* Mission */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-card dark:bg-card rounded-2xl p-6 sm:p-8 shadow-sm border border-border">
            ...
            <div className="border-l-4 border-blue-600 dark:border-blue-500 bg-blue-50 dark:bg-blue-950/30 rounded-r-xl p-4 mb-4">
              <p className="text-foreground dark:text-slate-200 italic text-lg" style={{ fontFamily: 'Georgia, serif' }}>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <em className="text-blue-600 dark:text-blue-400"> quality you can trust, at prices you can afford.</em>
            </p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-card dark:bg-card rounded-2xl p-6 sm:p-8 shadow-sm border border-border">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              An India that is truly <em className="text-blue-600 dark:text-blue-400">Rich in Health</em>.
            </p>
          </motion.div>

          {/* Promise */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-blue-600 dark:bg-blue-900 rounded-2xl p-6 sm:p-8 text-white">
            <div className="flex items-center gap-3 mb-4">
