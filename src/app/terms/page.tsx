...
import { ArrowLeft, FileText, Scale, AlertTriangle, CheckCircle, XCircle, Users, Shield } from 'lucide-react'
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700">You must be a licensed pharmaceutical retailer or distributor</p>
                  </div>
                  <div className="flex items-start space-x-3 mt-2">
                    <CheckCircle className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                    <p className="text-gray-700">You must provide accurate business and license information</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-orange-50 p-6 rounded-lg">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Payment Terms</h3>
              ...
              <section>
                ...
                <div className="bg-indigo-50 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Delivery Policy</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Return Policy</h3>
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <section>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-2 text-gray-700">
                    ...
                    <p><strong>License:</strong> WLF21B2023CH0002</p>
                  </div>
                </div>
              </section>
            </div>
