...
// Use proper service role key - this is critical for user management
...
if (!supabaseServiceKey) {
  console.error('SUPABASE_SERVICE_ROLE_KEY is not set! This will cause user management issues.')
}
