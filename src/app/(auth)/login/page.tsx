    ...
    return (
      <div className={`min-h-screen flex items-center justify-center transition-colors duration-300 ${darkMode ? 'bg-slate-950' : 'bg-slate-50'}`}>
        <div className="text-center">
          ...
          <p className={darkMode ? 'text-white/80' : 'text-slate-600'}>Loading...</p>
        </div>
      </div>
    )
  }
    ...
    <div className={`min-h-screen flex items-center justify-center p-4 transition-colors duration-300 ${darkMode ? 'bg-slate-950' : 'bg-slate-50'}`}>
      ...
      <Card className={`w-full max-w-md shadow-2xl transition-colors duration-300 ${darkMode ? 'bg-slate-900/90 border-slate-700' : 'bg-white/90 border-slate-200'}`}>
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-slate-900'}`}>Welcome Back</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                required
                className={`w-full h-12 rounded-xl border-2 ${darkMode ? 'bg-slate-800 border-slate-700 text-white placeholder:text-slate-400 focus:border-slate-500' : 'bg-white border-slate-300 text-slate-900 placeholder:text-slate-400 focus:border-slate-500'}`}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full h-12 rounded-xl border-2 pr-10 ${darkMode ? 'bg-slate-800 border-slate-700 text-white placeholder:text-slate-400 focus:border-slate-500' : 'bg-white border-slate-300 text-slate-900 placeholder:text-slate-400 focus:border-slate-500'}`}
                  placeholder="••••••••"
                  style={{ WebkitTextFillColor: darkMode ? 'white' : 'rgb(15, 23, 42)' }}
                />
                <button
          ...
          <div className="text-center text-sm">
            <span className={darkMode ? 'text-slate-400' : 'text-slate-500'}>New to Agorich? </span>
            <Link href={`/signup`} className="text-slate-600 hover:text-slate-900 hover:underline">
              Create an account
            </Link>
            <span className={darkMode ? 'text-slate-400' : 'text-slate-500'}> (mobile number required)</span>
          </div>
