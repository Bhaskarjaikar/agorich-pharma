            ...
            >
              ...
              <div className="border-b-2 border-gray-800 p-4">
                <div className="text-center mb-4">
                  <h1 className={`text-2xl font-bold ${invoiceData.invoiceNumber?.startsWith('AGR-DRAFT') ? 'text-amber-600' : 'text-blue-600'}`}>
                    {invoiceData.invoiceNumber?.startsWith('AGR-DRAFT') ? 'DRAFT ORDER' : 'GST INVOICE'}
                  </h1>
                  <p className={`text-sm ${invoiceData.invoiceNumber?.startsWith('AGR-DRAFT') ? 'text-amber-600' : 'text-gray-600'}`}>
                    {invoiceData.invoiceNumber?.startsWith('AGR-DRAFT') ? 'PROFORMA' : 'CREDIT'}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div>
                    <p className="font-semibold">
                      {invoiceData.invoiceNumber?.startsWith('AGR-DRAFT') ? 'Order No: ' : 'Invoice No: '}
