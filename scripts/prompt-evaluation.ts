...
function evaluatePromptResponse(
...
function evaluatePromptVersion(
  prompt: PromptVersion,
  queries: typeof sampleQueries
): EvaluationResult {
...
async function main() {
  ...
  console.log('\nRank\tVersion\t\tName\t\t\t\tOverall Score')
  console.log('-----\t-------\t\t----\t\t\t\t-------------')
  ...
  console.log('1. Baseline (v1.0.0): Strong all-around performance with clear guidelines')
  console.log('2. Empathy (v1.1.0): Higher relationship focus, good for customer retention')
  console.log('3. Efficient (v1.2.0): More direct approach, faster resolution times')
...
export { evaluatePromptVersion, EvaluationResult }